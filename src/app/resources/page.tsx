              ...
              <CardContent className="space-y-4">
                <ol className="list-decimal pl-5 space-y-3">
                  ...
                  <li>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Select your input token (e.g., SOL/USDC) → paste CA → select SIGNS → confirm swap.</p>
                  </li>
                </ol>
              </CardContent>
            ...
            <AccordionItem value="setup-security">
              ...
              <AccordionContent>
                <div className="space-y-3 text-sm leading-relaxed">
                  ...
                  <p>Consider a hardware wallet for larger holdings.</p>
