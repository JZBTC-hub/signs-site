...
export default function AboutClient() {
  ...
  const roadmapSrc = "/images/roadmap.png"; // put your image in /public/images/
  ...
  React.useEffect(() => {
    const onKey = (e: KeyboardEvent) => e.key === "Escape" && closeRoadmap();
    ...
    <main className="min-h-screen bg-black text-zinc-200">
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          ...
          aria-hidden="true"
        />
        <div className="relative z-10 mx-auto max-w-5xl px-6 pt-20 pb-12 md:pt-28 md:pb-16">
          <motion.h1
            variants={fadeUp}
            initial="hidden"
            animate="show"
            className="text-3xl md:text-5xl font-semibold tracking-tight text-white drop-shadow-[0_1px_1px_rgba(0,0,0,0.6)]"
          >
            When we make it, we won’t say a word.<br />
            <span className="text-[#d4af37] drop-shadow-[0_0_4px_rgba(212,175,55,0.6)]">
...
{/* Ethos */}
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12 md:pb-20">
        ...
        >
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
            ...
            <p className="mt-2 text-sm text-zinc-300">
              SIGNS is run by a small, relentless core — traders, builders, and visionaries — united by one goal: to make this the most exclusive brand in crypto. We provide so much value to holders that gambling on hollow memes stops being an option.
            </p>
      ...
      {/* Lightbox */}
      {isLightboxOpen && (
        <div role="dialog" aria-modal="true" aria-label="SIGNS Roadmap" className="fixed inset-0 z-50">
          <div className="absolute inset-0 bg-black/80 backdrop-blur-sm" onClick={closeRoadmap} />
          <div className="absolute inset-0 flex items-center justify-center p-4">
            <div className="relative max-h-[92vh] max-w-[92vw]">
              ...
              <button
                ...
                className="absolute -right-3 -top-3 rounded-full bg-white text-black px-3 py-2 text-xs font-semibold shadow-lg hover:bg-zinc-200"
